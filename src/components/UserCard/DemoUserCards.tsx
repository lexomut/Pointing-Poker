...
export const DemoUserCards: React.FC = () => {
    return (
        <>
            <UserCard name="Mark" initials="MZ" position="junior front-end developer" kickID={1} />
            <UserCard name="Linda Atkins" initials="LA" position="senior" currentUser kickID={1} />
            <UserCard
                name="Barsik"
                initials="JL"
